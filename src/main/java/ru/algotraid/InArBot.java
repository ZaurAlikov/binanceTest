...
public class InArBot {
    ...
    public void buyCycle(Double sumForTrade, String firstPair, String secondPair, String thirdPair, boolean directBuy) {
        ...
        countPayCoins = buyCoins(sumForTrade, firstPair, directBuy, 1);
        countPayCoins = buyCoins(countPayCoins, secondPair, directBuy, 2);
        countPayCoins = buyCoins(countPayCoins, thirdPair, directBuy, 3);
    ...
    private Double buyCoins(Double sumForTrade, String pair, boolean direct, int numPair) {
        Double pairQuantity;
...
//                if (isValidQty(pair, normalQuantity)) executedQty = buyOrSell(pair, normalQuantity, numPair, direct);
                break;
            case 2:
